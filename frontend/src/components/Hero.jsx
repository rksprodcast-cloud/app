  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center pt-20">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url(${projectData.images[0]})`,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl text-white">
          <div className="inline-block bg-amber-600/90 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
          ...
          <p className="text-2xl md:text-3xl mb-6 text-amber-100 font-light">
            {projectData.tagline}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href={`tel:${projectData.contact}`}>
              <Button 
                size="lg" 
                variant="outline" 
                className="bg-white/10 backdrop-blur-sm text-white border-white hover:bg-white hover:text-gray-900 text-lg px-8 py-6 w-full sm:w-auto"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-12 pt-12 border-t border-white/30">
            <div>
              <p className="text-3xl font-bold text-amber-400">2 & 3 BHK</p>
              <p className="text-sm text-gray-200 mt-1">Apartment Options</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-amber-400">1625-1929</p>
