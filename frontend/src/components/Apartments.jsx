      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {projectData.apartments.map((apartment) => (
            <Card key={apartment.id} className="overflow-hidden border-2 hover:border-coral-400 transition-all duration-300 hover:shadow-2xl">
              <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-teal-100 text-sm">Apartment</p>
                    </div>
                  </div>
                </div>
